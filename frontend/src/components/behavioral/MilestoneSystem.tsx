          ...
          >
            <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 p-3">
              <div className="flex items-center justify-between mb-3">
                <div>
                  <h3 className="text-lg font-bold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent flex items-center space-x-2">
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex items-start space-x-3 flex-1">
                        <div className={`p-2 rounded-lg bg-gradient-to-r ${milestone.color} text-white shadow-md group-hover:scale-105 transition-transform duration-200`}>
                          {milestone.icon}
                        </div>
                ...
                <div className="mt-3 pt-2 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="space-y-1">
                    {achievements.slice(-2).map(achievement => (
                      <motion.div
                        key={achievement.id}
                        className={`p-1.5 rounded-lg bg-gradient-to-r ${getRarityColor(achievement.rarity)} text-white text-xs`}
