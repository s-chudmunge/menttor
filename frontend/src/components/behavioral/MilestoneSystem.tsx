      ...
      <AnimatePresence>
        {showMilestonePanel && (
          <motion.div
            ...
            className="fixed top-20 left-20 z-50 w-80 max-h-[85vh] overflow-y-auto"
          >
            <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 p-4">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300 bg-clip-text text-transparent flex items-center space-x-3">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">Track your learning achievements</p>
                </div>
                <button
                  ...
                  <motion.div
                    ...
                    className={`p-5 rounded-2xl transition-all duration-300 cursor-pointer group ${
                      milestone.isCompleted
                        ? 'bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 border-2 border-green-200 dark:border-green-600 shadow-lg shadow-green-500/10'
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-start space-x-4 flex-1">
                        <div className={`p-3 rounded-xl bg-gradient-to-r ${milestone.color} text-white shadow-lg group-hover:scale-110 transition-transform duration-200`}>
                          {milestone.icon}
                        </div>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="relative w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3 overflow-hidden">
                        <motion.div
                          className={`bg-gradient-to-r ${milestone.color} h-full rounded-full relative`}
                          initial={{ width: 0 }}
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-3">
                      <div className="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-2">Rewards:</div>
                      <div className="flex flex-wrap gap-1">
                        {milestone.rewards.map((reward, idx) => (
                          <span key={idx} className="text-xs bg-white dark:bg-gray-600 text-gray-700 dark:text-gray-300 px-2 py-1 rounded-full border border-gray-200 dark:border-gray-600">
                            {reward}
                          </span>
                        ))}
                      </div>
                ...
                <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="space-y-2">
                    {achievements.slice(-3).map(achievement => (
                      <motion.div
                        key={achievement.id}
                        className={`p-2 rounded-lg bg-gradient-to-r ${getRarityColor(achievement.rarity)} text-white text-xs`}
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="opacity-90 text-xs">+{achievement.xpReward} XP</div>
                          </div>
        ...
        {newAchievements.map(achievement => (
          ...
          >
            ...
            <motion.div
              ...
              className={`relative bg-gradient-to-br ${getRarityColor(achievement.rarity)} rounded-2xl p-8 shadow-2xl text-white max-w-md text-center`}
