        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 items-start">
              ...
              {/* Step 1: Subject */}
              <div className="relative">
                <div className="bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl p-6 hover:border-green-600 dark:hover:border-green-500 transition-all duration-300 hover:shadow-lg">
