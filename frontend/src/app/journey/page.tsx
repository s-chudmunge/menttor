...
const JourneyPage = () => {
  ...
  if (loading || isLoadingRoadmap) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-blue-100 dark:journey-page-bg transition-colors duration-300 flex items-center justify-center px-4">
  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-blue-100 dark:journey-page-bg transition-colors duration-300">
        {/* Header */}
        <JourneyHeader 
          user={user}
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-8">
              ...
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between space-y-6 lg:space-y-0">
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                    <div className="flex items-center space-x-3 bg-white/50 dark:journey-page-bg/50 rounded-lg p-3">
          ...
          <div className="mb-8">
            <div className="bg-white/80 dark:journey-page-bg/80 backdrop-blur-sm rounded-2xl p-1.5 border border-gray-200/50 dark:border-gray-700/50 shadow-lg inline-flex">
              <button
