...
const RoadmapShareButton: React.FC<RoadmapShareButtonProps> = ({ 
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {showShareOptions && (
        <>
          <div className="absolute right-0 mt-2 w-72 max-w-[calc(100vw-2rem)] bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1 z-50 max-h-[80vh] overflow-y-auto xl:right-0 lg:right-0 md:right-0 sm:right-[-10rem] right-[-10rem]">
            <div className="px-3 py-2 border-b border-gray-100 dark:border-gray-700">
              <h4 className="font-medium text-gray-900 dark:text-white text-sm">Share Roadmap</h4>
            </div>
            ...
            <div className="p-2 space-y-1">
              ...
              {typeof navigator !== 'undefined' && 'share' in navigator && (
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-white">Share via device</span>
                </button>
              )}

              {/* Social Media Platforms */}
              <div className="space-y-1">
                <p className="text-xs font-medium text-gray-500 dark:text-gray-400 px-3 pt-1">Social Media</p>
                ...
                <button
                  ...
                  className="w-full flex items-center space-x-3 px-3 py-2 text-left hover:bg-gray-50 dark:hover:bg-gray-700 rounded-md transition-colors"
                >
                  <div className="w-6 h-6 bg-black dark:bg-gray-900 rounded-md flex items-center justify-center">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-white">Reddit</span>
                </button>
